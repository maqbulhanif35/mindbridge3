...
class _CommunityScreenState extends State<CommunityScreen>
  ...
  List<_Post> _buildInitialPosts() => [
        _Post(
          id: 1,
          content:
              "HELB hasn't disbursed and my fees deadline is next Friday. I've been skipping meals to save money. The stress is too much — has anyone else been through this? How do you cope?",
          tag: 'HELB',
          emoji: '😞',
          likes: 134,
          comments: 67,
          timeAgo: '1h ago',
          isAnonymous: true,
          reactions: {0: 78, 1: 56, 3: 40},
          mockComments: [
            "Pole sana. Go to the finance office and ask for a fee deferment — most unis allow it.",
            "I was in the same boat last sem. The Student Welfare office helped me get an emergency bursary.",
            "Talk to your HOD, they've seen this before and can buy you time. You're not alone. 🙏",
          ],
        ),
        _Post(
          id: 2,
          content:
              "CAT results came out and I passed all 4 units! Six months ago I nearly dropped out because of anxiety. If you're struggling right now — pole, but please don't give up. Kila kitu itakuwa sawa. 💪",
          tag: 'Recovery',
          emoji: '💚',
          likes: 389,
          comments: 94,
          ...
          isAnonymous: false,
          isSupported: true,
          reactions: {0: 167, 3: 122, 2: 100},
          mockComments: [
            "Hongera sana! This gave me hope today 💚",
            "You're inspiring so many of us. Keep going!",
        ...
        _Post(
          id: 3,
          content:
              "Does anyone else feel incredibly lonely on campus even when surrounded by people? I sit in the lecture hall, smile, nod — then go back to my hostel and feel empty. Is this normal?",
          tag: 'Loneliness',
          emoji: '💙',
          likes: 203,
          comments: 88,
          timeAgo: '5h ago',
          isAnonymous: true,
          reactions: {1: 134, 3: 69},
          mockComments: [
            "Yes, especially in a big lecture hall of 400+ students. It can feel very isolating.",
            "I felt this all through first year. Please try talking to the campus counselor.",
            "You described exactly how I feel. You're not alone in feeling alone. 💙",
          ],
        ),
        _Post(
          id: 4,
          content:
              "3rd all-nighter this week because the library closes at 10pm and my hostel is too noisy. CATs are next week. Any study spots on or near campus that are open late? 😭",
          tag: 'Academic',
          emoji: '😴',
          likes: 56,
          comments: 73,
          ...
          reactions: {0: 29, 2: 27},
          mockComments: [
            "Some 24hr cyber cafes near campus work well — 50 bob per hour.",
            "Pomodoro technique + early mornings changed my life. 4am is peaceful.",
            "Campus chapel sometimes stays open late. Check with the chaplain's office.",
          ],
        ),
        _Post(
          id: 5,
          content:
              "Reminder: you are not your CGPA. You are not your attachment grade. You are not your HELB balance. You are a full human being and you deserve rest, joy, and peace. Be kind to yourself today. 🌟",
          tag: 'Inspiration',
          emoji: '🌟',
          likes: 612,
          comments: 103,
          ...
          isAnonymous: false,
          isSupported: true,
          reactions: {0: 290, 3: 201, 2: 121},
          mockComments: [
            "Needed this more than you know. Thank you 🌟",
            "Saving this and reading it every morning.",
        ...
        _Post(
          id: 6,
          content:
              "My attachment company hasn't paid any of us for 3 months despite the attachment agreement. Anyone know if there's a way to report this or get help? I'm broke and exhausted.",
          tag: 'Attachment',
          emoji: '😤',
          likes: 178,
          comments: 61,
          ...
          reactions: {0: 89, 3: 89},
          mockComments: [
            "Report to your university's attachment coordinator — they have authority to intervene.",
            "The Ministry of Labour Kenya has a complaint desk. This is actually illegal.",
            "Same happened to me. Department stepped in and it got resolved. Document everything.",
          ],
        ),
        _Post(
          id: 7,
          content:
              "Started using the MindBridge journal feature during exam season and it genuinely helped me process the pressure without exploding. 30 days in, I feel calmer. Try it for just one week. 📝",
          tag: 'Wellness',
          emoji: '📝',
          likes: 234,
          comments: 47,
          ...
          isAnonymous: false,
          isSupported: true,
          reactions: {0: 112, 2: 122},
          mockComments: [
            "The journal prompts are really thoughtful. Helped me realize my anxiety triggers.",
            "MindBridge journal + breathing exercises = game changer during CAT season 💪",
          ],
        ),
      ];
